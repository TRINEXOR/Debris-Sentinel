...
# On Render free tier, only download best_model.pth to save RAM
# (ensemble checkpoints disabled — each is 57 MB)
_SLIM = os.getenv("SLIM_DEPLOY", "true").lower() == "true"
MODEL_FILES = ["best_model.pth"] if _SLIM else [
    "best_model.pth",
